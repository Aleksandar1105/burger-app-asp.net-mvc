    ...
    public class BurgerAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Burger>().HasData(
                ...
                new Burger { Id = 5, Name = "Mushroom Swiss Burger", Price = 260, IsVegetarian = false, IsVegan = false, HasFries = false, ImageUrl = "https://littlespicejar.com/wp-content/uploads/2018/06/Rockin-Sweet-Onion-Swiss-Mushroom-Burger-1-720x720.jpg" });
